...
In this code we deploy OpenWhisk control plane on Kubernetes cluster, while the action containers are spawned by talking to docker daemon on Kubernetes slave machine(s) directly. For more details about the scope, please visit [here](https://github.com/apache/incubator-openwhisk-deploy-kube#limitations)
